...
module.exports.run = async (client, message, args) => {
    ...
    if (args[1] == null) {
        ...
        return message.channel.send(embed).msg.delete(60);
    ...
    if (args[1] == "1") {
        ...
        var politieEmbed = new discord.MessageEmbed()
            ...
            .setColor("#283dfc")
            .setFooter("Arnhem Trainingen", "https://cdn.discordapp.com/attachments/747728968769339393/764909689242124288/Screenshot_20201011-195752_Samsung_Internet.jpg")
            .addFields(
        ...
        var DienstSpecialeInterventiesEmbed = new discord.MessageEmbed()
            .setTitle("Beveiliging training")
            .setColor("#058db3")
            .setFooter("Arnhem Trainingen", "https://cdn.discordapp.com/attachments/747728968769339393/764909689242124288/Screenshot_20201011-195752_Samsung_Internet.jpg")
            .addFields(
                { name: "Dienst", value: "Beveiliging" },
                { name: "Type-Training", value: `${options.TypeTraining}` },
                { name: "Docent", value: `${message.author}` },
                { name: "2de Docent", value: `${options.Hulp}` },
                { name: "Datum", value: `${options.Datum}` },
